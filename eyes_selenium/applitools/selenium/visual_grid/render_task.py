...
from applitools.selenium.visual_grid import resource_collection_service
...
class RenderTask(VGTask):
    ...
    def prepare_data_for_rg(self, data):
        ...
        collected_future = resource_collection_service.instance.collect_resources(
            data, self.eyes_connector, self.resource_cache
        )
        dom, self.full_request_resources = collected_future.result()
